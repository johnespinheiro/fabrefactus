...
$update2=$conn->query("UPDATE `clientes` SET `ativo` = '0' WHERE `id` ='".$id."' ");
$update3=$conn->query("UPDATE `movimentos` SET `status` = '0', `ativo` = '0' WHERE `idcliente` ='".$id."' ");
$update4=$conn->query("UPDATE `carros` SET `status`= '0', `linhauso` = NULL, `idcliente` = NULL WHERE `idcliente` ='".$id."' ");

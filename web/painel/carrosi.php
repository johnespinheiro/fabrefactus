...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CARROS
        <small>Visualização de Carros Inativos</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="carrosi.php">Carros Inativos</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" id="tabelalinhas">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="dtablecarrosi" class="table table-bordered table-striped dt-responsive nowrap" style="width:100%">
                <thead>
                <tr>
<!--                  <th>ID</th> -->
                  <th>Linha</th>

          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="inbox.php"><i class="fa fa-inbox"></i> Entrada
            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table id="dtablemail" class="table table-hover table-striped">
                  ...
                  <tbody>
<?php
  $res=$conn->query("SELECT * FROM `messages` WHERE `receiverid` = '".$usuarioID."' AND `boxreceiver` = '1' order by status ASC, senddate DESC ");
  $counts = $res->num_rows;
...
?>              
                  <tr>
                    <td><a id="readmail" data-mid="<?php echo $messageid;?>" href="readmail.php?read=<?php echo $messageid;?>&pag=1"><?php echo $sendernome;?></a></td>
                    <td><?php echo $statsubject;?></td>

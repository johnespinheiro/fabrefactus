...
<head>
  ...
  <!-- datetime picker -->
  <link rel="stylesheet" type="text/css" href="plugins/datetime-picker/bootstrap-datetimepicker.min.css">
  <!-- Theme style -->
...
//    echo "<script>alert('detectou sender c')</script>";
  ...
  ?>
                  <li><!-- start message -->
                    <a href="suporte/readmail.php?read=<?php echo $messageidvm;?>&pag=1">
                      <div class="pull-left">
...
<?php } ?>       <!-- end message -->
              ...
              <li class="footer"><a href="suporte/inbox.php">Ver todas as mensagens</a></li>
            </ul>
          </li>
         <!-- User Account Menu -->

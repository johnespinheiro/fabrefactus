...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CLIENTES
        <small>Visualização de Clientes ativos, anuncios e historico</small>
      </h1>
      <ol class="breadcrumb">
...
<!--      <td><?php //echo $id;?></td> -->
      ...
      <td>
      <a class="desativarcliente" id="<?php echo $id ?>" data-tabela="clientes" data-codcliente="<?php echo $id;?>" data-usuarionome="<?php echo $usuarioNome; ?>"><button class="btn btn-sm btn-danger">Desativar</button></a>
    </td>
    </tr>
  </tbody>
              </table>

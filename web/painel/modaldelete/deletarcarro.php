...
function excluirArquivo($arquivo){
   ...
   $resfm=$conn->query("SELECT `foto` FROM `movimentos` WHERE `idcarro` = '".$idcarro."' AND `dfoto` = '1' ");
...
$delete1 = mysqli_query($conn, "DELETE FROM movimentos WHERE idcarro='$idcarro' AND idlinha='$idlinha' ");
$delete1 = mysqli_query($conn, "DELETE FROM carros where id='$idcarro'");

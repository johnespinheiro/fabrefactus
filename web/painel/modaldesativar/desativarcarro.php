...
$update2=$conn->query("UPDATE `carros` SET `status` = '0', `ativo` = '0' WHERE `codlinha` ='".$codlinha."' AND `numerocarro` ='".$carro."' ");
$update3=$conn->query("UPDATE `movimentos` SET `status` = '0', `ativo` = '0' WHERE `codlinha` ='".$codlinha."' AND `numerocarro` ='".$carro."' ");
$update4=$conn->query("UPDATE `carros` SET `status`= '0', `linhauso` = NULL, `idcliente` = NULL WHERE `numerocarro` ='".$carro."' ");
